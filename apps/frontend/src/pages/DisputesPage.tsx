...
export function DisputesPage() {
  ...
  const mockDisputes: Dispute[] = [
    {
      id: 'RSK-009',
      title: 'Algeria Mining License Revocation - Retaliatory Action Risk',
      type: 'arbitration',
      status: 'active',
      priority: 'critical',
      client: 'SaharaMinerals',
      opposingParty: 'Government of Algeria',
      attorney: 'Amara Touré',
      filingDate: '2025-01-15',
      dueDate: '2025-08-30',
      estimatedValue: 15000000,
      actualCosts: 240000,
      description: 'ICSID arbitration proceedings following mining license revocation. Risk of regulatory shutdown requiring EU backing.',
      courtName: 'ICSID Arbitration Centre',
      caseNumber: 'ARB/25/3',
    ...
    {
      id: 'RSK-010',
      title: 'Gas Supply Contract Arbitration - ₦9.4B Exposure',
      type: 'arbitration',
      status: 'active',
      priority: 'high',
      client: 'NaijaGas',
      opposingParty: 'Energy Consortium Nigeria',
      attorney: 'Chidi Okafor',
      filingDate: '2024-12-01',
      dueDate: '2025-09-10',
      estimatedValue: 9400000000,
      actualCosts: 185000000,
      description: 'Financial exposure on gas supply contract dispute. Engaging new expert witness and renegotiating timelines.',
    ...
    {
      id: 'RSK-011',
      title: 'NDPR Data Class-Action Lawsuit',
      type: 'litigation',
      status: 'active',
      priority: 'medium',
      client: 'NaijaCredit',
      opposingParty: 'Data Breach Victims Class',
      attorney: 'Ifeoma Ajayi',
      filingDate: '2025-04-10',
      dueDate: '2025-07-25',
      estimatedValue: 500000000,
      actualCosts: 45000000,
      description: 'Class-action fallout under Nigeria NDPR. Public apology issued, defense strategy in preparation.',
      courtName: 'Federal High Court Lagos',
      caseNumber: 'FHC/L/CS/567/2025',
    ...
    {
      id: 'RSK-012',
      title: 'South Africa SOE Reform - Procurement Eligibility Challenge',
      type: 'litigation',
      status: 'pending',
      priority: 'high',
      client: 'BuildAfrica SA',
      opposingParty: 'Department of Trade and Industry',
      attorney: 'Thabo Mthembu',
      filingDate: '2025-05-20',
      dueDate: '2025-07-20',
      estimatedValue: 2500000000,
      actualCosts: 12000000,
      description: 'SOE reform bill affects procurement eligibility. Liaising with DTI legal desk and submitting impact memo.',
      courtName: 'High Court of South Africa',
      caseNumber: 'GP-2025-24578',
    ...
    {
      id: 'RSK-013',
      title: 'Egypt JV Exit Clause Trigger - Central Bank Regulation',
      type: 'negotiation',
      status: 'active',
      priority: 'critical',
      client: 'MobiPay Egypt',
      opposingParty: 'JV Partner (Confidential)',
      attorney: 'Ahmed El-Rashid',
      filingDate: '2025-06-01',
      dueDate: '2025-08-15',
      estimatedValue: 750000000,
      actualCosts: 25000000,
      description: 'JV partner may trigger exit clause due to central bank regulation. Initiating renegotiation or exploring M&A interest.',
